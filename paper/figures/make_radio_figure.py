...
l1,a,b = ax.errorbar(high_freq_22[0], high_freq_22[1], high_freq_22[1]*0.2, uplims=True, label= '22 GHz detection')
...
plt.legend(bbox_to_anchor=[0.04, 0.48, 0.5, 0.5], framealpha=0)
