...
Recent, unprecedented early spectroscopy of some IIP/IIL SNe show narrow emission lines that disappear within the first hours to days post explosion (e.g. \citet{2014gal-yam}, \citet{ 2017yaron}), indicating a thin dense CSM shell around the progenitor. 
...
Although very few in number, X-ray and radio observations are also detecting signs of interaction around some type IIP/IIL SNe (e.g. \citet{2014dwarkadas} and references there in, \citet{2018morozova2}).
...
Additional data were obtained with in the radio with the VLA (VLA/15B-362, PI: Valenti). 
...
After the fall from plateau, the main contribution to the light curve is the energy produced by the radioactive decay of ${}^{56}$Ni.
...
This is significantly higher than radio mass-loss rate which is consistent with the typical RSG mass-loss rate of $10^{-4} $- $10^{-6}$ \msun/yr, although not inconsistent with late stage mass-loss scenarios (e.g. \citet{2012quatert,2014shiode,2017fuller, 2017yaron}).
...
A dense shell of material surrounded by a lower density CSM has been used to model the observations of a handful of objects (e.g. 2013fs: \citet{2017yaron}; 2013ej: \citet{2018morozova2}).
