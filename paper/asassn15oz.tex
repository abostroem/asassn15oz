...
They described type IIP light curves as having a rapid decline in the first $\sim$30 days post maximum, followed by $\sim$50 days of constant brightness (the {\it plateau}), followed by a rapid decline until $\sim$ 120 post maximum, and finally settling onto a reduced decline. 
Type IIL light curves on the other-hand are characterized by a {\it linear} decline for up to 100 days post maximum. 
...
Ignoring IIn and IIb SNe, type IIP/L SNe show great diversity in their spectroscopic properties and light curve shape. 

The analysis of large samples of SNe by \citet{2014anderson} and \citet{2015sanders} showed a continuum distribution between the archetypical IIP and IIL light curves, strengthen the observations of earlier authors made on smaller samples (e.g. \citet{1989young}, \citet{1993patat, 1994patat}). 
However, some authors continue to find two distinct classes (e.g. \citet{2012arcavi}).
...
Successful modeling of type IIP-like SNe with a RSG progenitor has shown that the initial period of decline is due to adiabatic cooling during the expansion of the ejecta (e.g. \citet{1971grassberg}, \citet{1976chevalier}, \citet{1977falk}, \citet{1985litvinova},\citet{1993blinnikov}, \citet{2009kasen}).
...
When the photosphere passes completely through the hydrogen dominated layer of the ejecta, the ejecta continues to expand and cool, as layers become optically thin until the light curve is powered by the radioactive decay of nickel and cobalt.
...
It has been theorized that type IIL-like light curves arise from progenitors with a smaller hydrogen envelope \citep{1971grassberg, 1993blinnikov}.
In this scenario, the recombination front would move faster than the expanding ejecta, causing the brightness to decrease. 
The shallow H-$\alpha$ absorption troughs in type IIL-like SNe strengthen this picture \citep{1990schlegel, 2014gutierrez}.
As the progenitors of type IIP/L SNe are thought to be single, they would need to lose mass via stellar winds to explode with a smaller hydrogen envelope.
...
This idea is intriguing as it solves another outstanding problem, the lack of progenitors between 17-25 \msunperiod.
...
Mass loss rates for RSG are extremely difficult to characterize with observations due to both the short period of this phase as well as the rarity of high mass stars and it not well understood theoretically.
...
Although typically assumed to be negligible, it is possible that the signatures of interaction with circumstellar material (CSM; with stellar wind origins) are visible in the light curves and spectroscopy of type IIP/L SNe, especially outside of the optical where there are fewer observations.
The detection and evolution of this interaction can directly probe the mass loss history of massive stars. 

In fact, evidence of interaction, often characterized by a single type of observation (e.g. X-ray detection), indicate that mass loss should be considered in the interpretation of type IIP/IIL SNe.
...
Corroborating this picture (although for different objects), dense CSM is also required to match the early light curves of hydrodynamic models with RSG progenitors to the optical light curves \citep{2018morozova, 2018paxton}.
...
While signs of interaction in type IIP/IIL SNe exist, a coherent picture of mass-loss is exceedingly rare and has never been attempted for type II-L object, the SN type most likely to show signs of interaction.
In this paper, for the first time, we address this issue with the study of ASASSN-15oz, a type IIL-like supernova, for which we were able to collect and extensive set of data ranging from the X-ray to the Radio to search for signs of interaction with a CSM.
...
Finally, we present a comparison to other objects and a unified interpretation of the mass loss history indicated by the multi-wavelength observations  in \ref{SecComp}.
