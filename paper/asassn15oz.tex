...
Based on a sample of 9 events, \citet{1941minkowski} separated CCSN into Type I, those without hydrogen in their spectra and Type II, those with hydrogen in their spectra.
Although the diversity of Type II light curves was noted early \citep{1964minkowski, 1967pskovskii}, it was \citet{1979barbon} who first proposed a division of the Type II class into Type IIP and Type IIL based on the shape of their light curves.
They described Type IIP light curves as having a rapid decline in the first $\sim$30 days post maximum, followed by $\sim$50 days of constant brightness (the {\it plateau}), followed by a rapid decline until $\sim$ 120 post maximum (the fall from plateau), and finally settling onto a reduced decline (the radioactive decay phase). 
Type IIL light curves on the other-hand, replace the constant brightness plateau with a {\it linear} decline for up to 100 days post maximum. 
More recently, Type IIn and Type IIb subclasses have been defined as SNe with narrow emission lines in their spectra and SNe whose hydrogen lines give way to strong helium lines during their photospheric phase, respectively \citep{1990schlegel, 1993filippenko}.

Disregarding IIn and IIb SNe, Type IIP/IIL SNe show great diversity in their spectroscopic properties and light curve shape. 
Some authors continue to find a distinction between IIP and IIL light curves  (e.g. \citealt{2012arcavi}).
...
From high resolution imaging prior to the SNe explosion, the progenitors of Type IIP/IIL SNe have been shown to be red super giants (RSG) with masses $<$ 17  \msun (\citealt{2015smartt} and references there in).
Successful modeling of Type IIP-like SNe with a RSG progenitor has shown that the initial period of decline is due to adiabatic cooling during the expansion of the ejecta (e.g. \citealt{1971grassberg}, \citealt{1977falk}, \citealt{1993blinnikov}, \citealt{2009kasen}).
...
It has been theorized that Type IIL-like light curves arise from progenitors with  smaller hydrogen envelopes \citep{1971grassberg,1989branch,1993blinnikov}.
In this scenario, the recombination front would move faster than the expanding ejecta, causing the brightness to decrease. 
The shallow H-$\alpha$ absorption troughs in Type IIL-like SNe, possibly due to less absorbing material, strengthen this picture \citep{1996schlegel,2014gutierrez}.
As the progenitors of Type IIL-like SNe are thought to be single, they must lose mass via stellar winds to explode with smaller hydrogen envelopes.
As mass-loss increases with zero age main sequence mass (M$_{ZAMS}$), this leads to the hypothesis that the progenitors of Type IIL-like objects are more massive than IIP-like progenitors \citep{2003heger,2009kasen}. 
Observations that Type IIL-like SNe have sorter periods before falling to the radioactive decay phase, are brighter, and have higher velocity ejecta support this idea \citep{1994patat,2014anderson,2014faran,2015sanders,2016valenti} 
...
However, \citet{2016valenti} found that there is no difference in the progenitor population of IIP-like and IIL-like objects and more importantly, that the progenitors of Type IIL-like SNe were not above 17 \msunperiod.
...
Corroborating this picture (although for different objects), dense CSM is also required to match the early optical light curves of Type IIP/IIL with hydrodynamic models with RSG progenitors \citep{2018morozova,2018paxton}.
Although very few in number, X-ray and radio observations are also detecting signs of interaction around some Type IIP/IIL SNe (e.g. \citealt{2014dwarkadas} and references there in, \citealt{2018morozova2}).
\Azalee{ should I also mention individual objects with interaction claims: e.g. 1999em, 2004et?}

While signs of interaction in Type IIP/IIL SNe exist, a coherent picture of mass-loss is exceedingly rare and has never been attempted for Type IIL-like object, the subtype most likely to show signs of interaction.
In this paper, for the first time, we address this issue with the study of ASASSN-15oz, a Type IIL-like supernova, for which we were able to collect an extensive set of data ranging from the X-ray to the radio to search for signs of interaction with a CSM.
...
SNID has very few templates for Type IIL supernovae even after adding the new templates provided by \citet{2017gutierrez}. Therefore, we add templates for two well observed supernovae with well constrained explosion epochs: 2012A and 2013ej.
...
\caption{The Na I D1 and D2 lines in high resolution X-shooter spectrum from September 21, 2015 for galactic and host absorption.
...
The light curve of ASASSN-15oz shows a linear decline similar to that of other Type IIL-like SNe. 
...
Both the high slopes and bright maximum luminosity of ASASSN14oz are similar to those of other Type IIL-like SNe. 
%=======================
...
The fact that several Type IIP/IIL SNe do not have complete trapping (see Section \ref{SecComp}) should be taken into account in the future.
%=======================
\begin{figure}
\begin{center}
...
The linear shape of the light curve of Type IIL SNe is best explained by a thin hydrogen envelope on the progenitor, implying that IIL Sne should undergo more mass-loss than IIP-like SNe.
ASASSN-15oz, a Type IIL SNe with photometric and spectroscopic observations from the X-ray through the radio is the ideal SNe on which to study the importance of mass-loss for IIP-like and IIL SNe and if different observational signatures of interaction are consistent with each other. \Stefano{is there a better way to say this?}
...
Building on a similar analysis of single object (e.g. 1999em: \citealt{2001leonard}, 2013ej: \citealt{2014valenti}), \citet{2017gutierrez} searched for this feature in 122 Type IIP/IIL SNe. 
...
In the recent literature, there is a common agreement that the enhanced mass losses from the RSGs in the last years of their evolution are necessary to explain the early optical and UV observations of Type II supernovae (see, for example, \citealt{2015gezari}; \citealt{2017yaron}; \citealt{2018bullivant}; \citealt{2018foerster}). 
...
It is useful to compare observations of ASASSN-15oz to those of other Type IIP/IIL SNe to understand if it is a typical IIL SN or a unique event.
Although they are part of a continuous class, Type IIL SNe typically have higher velocity ejecta, are brighter, and have a steeper light curve slope than the average Type IIP-like SN.
...
Population studies of Type IIP/IIL SNe have found that SNe with steeper light curves are brighter \citep{2011li,2014anderson,2015sanders,2016valenti}, either due to a larger explosion energy, a larger progenitor, or both. \Stefano{Is this true, does it need a citation?}
...
As a bright Type IIL SNe, ASASSN-15oz is consistent with the sample correlation.
%=======================
\begin{figure}
\begin{center}
...
The steepness of the photospheric slope in a Type II light curve can be explained by the hydrogen recombination front receding faster than the ejecta expansion, implying a progenitor with a thinner hydrogen envelope.
...
Strongly interacting SNe remain UV bright throughout their interaction, implying that perhaps a UV excess would be observed for SNe IIP/IIL during the first 30 days, when the CSM has the greatest affect on the light curve.
...
\caption{Figure \ref{fig:UVColor} shows a comparison of the UV color of ASASSN-15oz to that of all other Type IIP/IIL supernovae with \textit{Swift} observations.
...
To gain more insight into the X-ray upper limit, we compare the ASASSN-15oz upper limit with published X-ray observations of Type IIP/IIL SNe found in the SNaX database \citep{2017ross} (see Figure \ref{fig:xray}).
...
Type IIP SNe are shown with square symbols while Type IIL-like SNe are shown with circular symbols and the upper limit of ASASSN-15oz is marked with a star.
All detections from Type IIP/IIL SNe are below the upper limit derived in this paper, implying that deeper observations would be required to detect the X-ray flux.}
\label{fig:xray}
\end{center}
\end{figure}
%-----------------------------------------
