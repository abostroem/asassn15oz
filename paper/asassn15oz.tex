...
For this reason, detection earlier than 30 days are interpreted as SiII.
At late times, however, it is challenging to interpret the cachito feature as anything other than Hydrogen due to the temperatures required to excite SiII.
