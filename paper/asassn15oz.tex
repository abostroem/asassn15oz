...
However, the recent analysis of large samples of SNe by \citet{2011li}, \citet{2014anderson} and \citet{2015sanders} show a continuum between the archetypical IIP and IIL light curves, strengthening the observations that earlier authors made on smaller samples (e.g. \citealt{1989young}, \citealt{1993patat}, and \citealt{1994patat}). 
...
As the progenitors of IIL-like SNe are thought to be single, they must lose mass via stellar winds to explode with smaller hydrogen envelopes.
...
Observations that IIL-like SNe have sorter periods before falling to the radioactive decay phase, are brighter, and have higher velocity ejecta support this idea \citep{1994patat,2014anderson,2014faran,2015sanders,2016valenti} 
...
However, \citet{2016valenti} found that there is no difference in the progenitor population of IIP-like and IIL-like SNe and more importantly, that the progenitors of IIL-like SNe were not above 17 \msunperiod.
Nevertheless, mass-loss, whether governed by progenitor mass or some other factor (e.g. metallicity, rotation) remains the most promising explanation of the diversity of light curve shapes.
...
\Azalee{ should I also mention individual objects with interaction claims: e.g. 1999em, 2004et?}
...
It is therefore reasonable to take as the mid-point between the non-detection and the detection as explosion date with the $1\sigma$ error being the time to the non-detection: $t_{expl} =$ 2015-08-27 $\pm 4$ days (JD 2457261.5).
...
SNID has very few templates for IIL-like SNe even after adding the new templates provided by \citet{2017gutierrez}. Therefore, we add templates for two well observed supernovae with well constrained explosion epochs: 2012A and 2013ej.
...
\Viktoriya{This behavior was previously noted by \citet{2018paxton} who find that the Fe II $\lambda$5169 line is originating above the photosphere where the Sobolov optical depth is a specific value (they find $\tau_{sob} \sim1$ fits the observations well). 
