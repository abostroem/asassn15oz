...
Disregarding IIn and IIb SNe, type IIP/L SNe show great diversity in their spectroscopic properties and light curve shape. 
...
As the progenitors of type IIL SNe are thought to be single, they must lose mass via stellar winds to explode with smaller hydrogen envelopes.
...
Although they are part of a continuous class, type IIL SNe typically have higher velocity ejecta, are brighter, and have a steeper light curve slope than the average type IIP SN.
...
Type IIP SNe are shown with square symbols while type IIL SNe are shown with circular symbols and the upper limit of ASASSN-15oz is marked with a star.
...
As the best model to explain the observations of a IIP SN (2013fs), a transition SN (2013ej), and now to a IIL SN (ASASSN-15oz) it may be applicable to a broad range of progenitors.
