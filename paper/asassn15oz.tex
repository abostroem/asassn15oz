...
However, the recent analysis of large samples of SNe by \citet{2014anderson} and \citet{2015sanders} show a continuum between the archetypical IIP and IIL light curves, strengthening the observations that earlier authors made on smaller samples (e.g. \citealt{1989young}, \citealt{1993patat}, and \citealt{1994patat}). 
...
To explode with smaller hydrogen envelopes, IIL-like SNe must lose mass via stellar winds.
...
Mass lost from a SN progenitor over the course of its lifetime will be distributed around progenitor with a density that is related to the mass-loss rate and the wind velocity at the time it was lost and to the time itself.
...
SN ASASSN-15oz was discovered by the ASAS-SN team on 2015-08-31 (JD 2457265) and announced on 2015-09-03 (JD 2457268) \citep{2016brown}. 
The next day, 2015-09-04 (JD 2457269.5), the Las Cumbres Observatory (LCO) classified it as a Type II SN one week after explosion \citep{2016hosseinzadeh}. 
Imaging of the host galaxy, HIPASS J1919-33, from 2015-08-23 (JD 2457257.5) does not show any evidence of ASASSN-15oz (V $>$ 17.8). 
...
Therefore, we add templates for two well observed supernovae with well constrained explosion epochs: SN 2012A and SN 2013ej.
We confirm our explosion epoch by fitting the first spectrum (2015-09-04; JD 2457269.5) using SNID v. 5.0, augmenting the templates with those of \citet{2017gutierrez}, SN 2012A \citep{2013tomasella}, and SN 2013ej \citep{2016childress,2016dhungana,2014valenti,2015smartt}.
...
\caption{The galactic (solid gray lines) and host (dashed gray lines) Na I D1 and D2 lines in the high resolution X-shooter spectrum from 2015-09-21 (JD 2457286.5).
...
Following the method described in \citet{2014spiro}, we find the nickel mass synthesized in the SN explosion by scaling the bolometric luminosity of ASASSN-15oz when it is powered by ${}^{56}Co$ to that of SN 1987A using the equation:
\begin{equation} \label{eqn:Ni}
M({}^{56}Ni) = 0.075M_{\odot} \times \frac{L_{sn}(t)}{L_{87A}(t)}
\end{equation}
where $M({}^{56}Ni)$ is the synthesized nickel mass, $L_{sn}(t)$ is the luminosity of the SN at time t, and $L_{87A}(t)$ is the luminosity of SN 1987A at time t.
...
An upper limit on the nickel mass can be obtains if ASASSN-15oz fell from plateau, over 20 days, immediately after the last photospheric point (see top panel of Figure \ref{fig:Ni}).
Assuming complete trapping at the end of the fall from plateau, we calculate a nickel mass of 0.1 \msun by scaling the luminosity at 102 days.
...
Using this $t_{pt}$ and a 20 day fall from plateau, we calculate the fall from plateau to end 135 days after explosion and extrapolate the tail fit to this phase (see lower panel of Figure \ref{fig:Ni}). 
...
Finally, we consider an intermediate nickel mass, the mean of the upper and lower limits, 0.095 \msunperiod.
%=======================
\begin{figure}
\begin{center}
...
Unfortunately, the SN passed behind the sun around day 80, leaving a gap in the observations from day 86 to day 184, most notably missing the fall from plateau.
Figure \ref{fig:LC} shows the complete multi-wavelength light curve.
...
UV and X-Ray imaging observations were obtained concurrently with \textit{Swift} program 1114241 from 2015-09-05 (JD 2457270.5) through 2015-11-18 (JD 2457344.5).
...
ASASSN-15oz was observed in the near infra-red (NIR) on 2015-09-05 (JD 2457270.5) and 2015-10-05 (JD 2457300.5) with the SOFI instrument on the NTT telescope and on 2015-10-10 (JD 2457305.5) with the SpeX instrument \citep{2003rayner} on the 3.0-m NASA Infrared Telescope Facility (IRTF).
...
Both the high slopes and bright maximum luminosity of ASASSN14oz are similar to those of other IIL-like SNe. 
%=======================
...
\caption{A comparison of the model spectrum produced by Syn++ and the observed spectrum from 2015-10-06 (JD 2457301.5).
...
Nebular spectra of ASASSN-15oz, were taken on 2016-04-11 (JD 2457489.5; day 228), 2016-08-03 (JD 2457603.5; day 340), and 2016-09-19 (JD 2457650.5; day 388) of which the first two were high enough S/N to model.
...
This value is a factor of four smaller than our lower limit for the nickel mass (see Section \ref{15ozIntro}).
...
\caption{The nebular spectra of ASASSN-15oz from 2016-04-11 (JD 2457489.5; day 228; top) and 2016-08-03 (JD 2457603.5; day 340; bottom) plotted with the scaled models of \citet{2014jerkstrand} for $M_{ZAMS}$ = 12, 15, 19, and 25 M$_{\odot}$. 
...
%FIXMEThe different wavelengths probe different periods of mass-loss allowing for the characterization of the mass-loss history of the progenitor.
...
\caption{The Swift UV spectrum from 2015-09-05 (JD 2457270.5; day 9). 
...
Building on a similar analysis of single objects (e.g. SN 1999em: \citealt{2001leonard}, SN 2013ej: \citealt{2014valenti}), \citet{2017gutierrez} searched for this feature in 122 IIP/IIL SNe. 
...
%FIXME - why does there have to be a carriage return here
...
We explore this by plotting {\it Swift} UV color, UVW2 - V, over the first 30 days of evolution for eight SNe in our database with both {\it Swift} photometry and $s_{50V}$ measurements (Figure \ref{fig:UVColor}). 
...
\caption{Figure \ref{fig:UVColor} shows a comparison of the UV color of ASASSN-15oz to that of all other IIP/IIL SNe with \textit{Swift} observations.
