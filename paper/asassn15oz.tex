...
However, the recent analysis of large samples of SNe by \citet{2014anderson} and \citet{2015sanders} show a continuum between the archetypical IIP and IIL light curves, strengthening the observations that earlier authors made on smaller samples (e.g. \citet{1989young}, \citet{1993patat, 1994patat}). 
...
From high resolution imaging prior to the SNe explosion, the progenitors of type IIP/IIL SNe have been shown to be red super giants (RSG) with masses $<$ 17\msun (\citet{2015smartt} and references there in).
Successful modeling of type IIP-like SNe with a RSG progenitor has shown that the initial period of decline is due to adiabatic cooling during the expansion of the ejecta (e.g. \citealt{1971grassberg}, \citealt{1977falk}, \citet{1993blinnikov}, \citet{2009kasen}).
...
%During this final phase, the radioactive decay tail, the gamma-rays given off by the radioactive decay of nickel synthesized during the explosion are absorbed by the hydrogen and re-emitted in the optical.
%When all gamma-rays are absorbed, called complete trapping, the slope during this phase is 0.98 mag/100 days.
...
\Stefano{should I remove this subsection or make sections for explosion epoch and dust?}
...
\Stefano{The IR equivalent of this plot has wavelengths listed. However, its challenging to have wavelengths for the optical since they are often a complex of multiple blended lines. 
Should I remove the wavelengths from the IR plot?}}
\label{fig:SpecAll}
\end{center}
\end{figure*}
%-----------------------------------------
...
Population studies of Type IIP/IIL SNe have found that SNe with steeper light curves are brighter \citep{2014anderson,2016valenti}, either due to a larger explosion energy, a larger progenitor, or both. \Stefano{Is this true, does it need a citation?}
