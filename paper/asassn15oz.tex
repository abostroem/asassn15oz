...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=\textwidth]{uv_slope_comp} %created by make_swift_color_fig.ipynb
...
\begin{figure}[h!] 
\begin{center}
\includegraphics{nebular_spectra_day340} %created by make_nebular_figure.ipynb
