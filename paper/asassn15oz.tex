...
%-----------------------------------------
%%%%%%%%%%%%%%%%% 
\subsection{UV and X-Ray Observations}
...
An upper limit in the X-ray observations was determined using aperture photometry.
Images were background subtracted using an aperture in a blank part of the image and measured fluxes were converted from counts to luminosity assuming a power-law model with a photon index of two.
We find a limiting count rate (inside an 18'' aperture) of  7.234x10$^{-4}$ counts s$^{-1}$.
