...
%Magic to make references split across pages without error
\usepackage{etoolbox}
\makeatletter
...
$\rm{^{8}}$Harvard-Smithsonian Center for Astrophysics,  60 Garden Street,  Cambridge, MA 02138 \\ %Griffin
...
Regions of severe sky contamination are marked with grey boxes and are masked out of the spectra.}
\label{fig:IRmontage}
\end{center}
\end{figure*}
%-----------------------------------------
...
%=======================
\input{slopes}%created by light_curve_characteristics.ipynb
%-----------------------------------------
...
\begin{figure}
\begin{center}
\includegraphics[width=\columnwidth]{log_rho} %created by make_log_rho_snec.ipynb
...
\begin{figure*}
\begin{center}
\includegraphics[width=\textwidth]{lc_comp_abs_slope} %created by light_curve_characteristics.ipynb
...
\begin{figure}
\begin{center}
\includegraphics[width=\columnwidth]{slope_compare} %created by light_curve_characteristics.ipynb
