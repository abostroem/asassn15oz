...
The Swift filters are denoted with an "s" in the name (e.g. us) for the optical filters and a "uw" in the name for UV filters.
...
These spectra are not template subtracted, thus most of the features are zeroth order images of other objects in the field.
...
\Azalee{Elaborate on why we think this is Si and not high velocity hydrogen} See Figures \ref{fig:CachitoEvolve} and \ref{fig:SiVelocity}.
%=======================
\begin{figure}
\begin{center}
\includegraphics[width=\columnwidth]{cachito_evolution}
\caption{The evolution of the cachito feature (center panel) over time. 
The feature is visible bluewards of H-$\alpha$  in the first spectrum, 8 days post explosion.
...
There is no evidence of a high velocity hydrogen feature in H-$\beta$ (left panel) although this is not surprising given the low opacities predicted by \citet{2007chugai}.
...
Given the uncertainty in the mass of ${}^{56}$Ni produced by ASASSN-15oz we produced models for the maximum, minimum, and mean value of synthesized ${}^{56}$Ni (see Section \label{SecNi}).
