...
\begin{itemize}
\item We detect the SN in radio observations, implying a mass-loss rate of $0.9x10^-6$ \msunperiod/yr for a wind velocity of 100 km/s.
\item High velocity H and He are searched for in the NIR and optical spectra. 
Although there is a feature bluewards of H-$\alpha$, no corresponding feature is observed in any other hydrogen line nor in the HeI ($\lambda 10830$) line. 
For this reason we identify it as Si II ($\lambda 6355$) rather than high velocity hydrogen.
\item To accurately model the early optical light curve, we require CSM around the RSG progenitor with a density of $10^{18}$ g/cm and radial extent of 2400 $R_{\odot}$, implying a short period of extreme mass-loss (e.g. assuming a wind velocity of 100 km/s, the mass-loss rate would be 2 \msunperiod/yr for 0.25 yrs).
\item No narrow emission lines are detected in the optical and UV photospheric spectroscopy, implying a mass-loss rate of $< 10^{-4}$ \msunperiod/yr.
\item No UV excess is detected in the first 40 days of observations.
\item No X-ray signal is detected in the sum of all photospheric observations, implying $L_{xray}<3.72x10^{39}$ erg/s.
\end{itemize}
