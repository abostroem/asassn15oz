...
Single, hydrogen-rich, core collapse supernovae typically divided into three classes: IIP-like, with a 100 day plateau following maximum light, IIL-like, showing a linearly declining light curve following maximum light, and IIn which show narrow emission lines in their spectra. These classification are indicative of the characteristics of the late stage evolution of the hydrogen envelope of the progenitor star. The plateau is explained by recombination through a thick envelope, the linear decline with recombination through a thinner envelope, and IIn with strong interaction with circumstellar material lost prior to explosion. For this reason, we generally do not consider interaction when modeling IIP-like and IIL-like supernovae. However, recent hydrodynamic modeling of IIP-like and IIL-like supernovae has been unable to reproduce the early (~30 days post explosion) light curve without the introduction of circumstellar material. One explanation for the smaller hydrogen envelope in IIL-like supernovae is mass loss, which would lead to circumstellar material. This makes IIL-like supernovae ideal for understanding whether IIP-like and IIL-like supernovae experience interaction. We test this hypothesis on ASASSN-15oz, a Type IIL-like supernova and the closest Type II supernova in 2015. With extensive follow-up in the x-ray, UV, optical, IR, and radio we search for signs of interaction. Interestingly, we find evidence of interaction in the radio and optical, but only upper limits in the X-ray and UV, leading to questions about universality of these indicators.
\end{abstract}
...
%% SNe II diversity, historically 2 classes but maybe a continuum. 
%% Then explain the difference IIL need a smaller envelope as also suggested by the modeling. 
%% However evidences says they all come from similar progenitors mass, so maybe similar progenitors but different mass loss history. 
%% Mass loss is one of the problem in theory. 
%% Evidence of csm have been observed but never studied in a coherent picture
%% 
%% Incorporate rates somewhere?
%% Incorporate other IIL explanations?
%% 
%% 
...
In this paper we will use IIP-like to denote SNe at the IIP end of the spectrum and IIL-like to denote SNe at the IIL end of the spectrum.

From high resolution imaging prior to the SNe explosion, the progenitors of IIP/IIL SNe have been shown to be red super giants (RSG) with masses $<$ 17  \msun (\citealt{2015smartt} and references there in).
Successful modeling of IIP-like SNe with a RSG progenitor has shown that the initial period of decline is due to adiabatic cooling during the expansion of the ejecta (e.g. \citealt{1971grassberg}, \citealt{1977falk}, \citealt{1993blinnikov}, \citealt{2009kasen}).
...
When the photosphere passes completely through the hydrogen dominated layer of the ejecta, the ejecta continues to expand and cool, as layers rapidly become optically thin until the light curve is powered by the radioactive decay of nickel and cobalt.

It has been theorized that IIL-like SN light curves arise from progenitors with  smaller hydrogen envelopes \citep{1971grassberg,1989branch,1993blinnikov}.
...
To explode with smaller hydrogen envelopes, IIL-like SNe lose mass via stellar winds.
As mass-loss increases with zero age main sequence mass (M$_{ZAMS}$), this leads to the hypothesis that the progenitors of IIL-like SNe are more massive than IIP-like progenitors \citep{2003heger,2009kasen}. 
Observations that IIL-like SNe have sorter periods before falling to the radioactive decay phase, are brighter, and have higher velocity ejecta support this idea \citep{1994patat,2014anderson,2014faran,2015sanders,2015valenti,2016valenti} 
...
However, \citet{2016valenti} found that there is not a clear difference in the progenitor population of IIP-like and IIL-like SNe and more importantly, that the progenitors of IIL-like SNe were not above 17 \msunperiod.
...
Mass lost from a SN progenitor over the course of its lifetime will be distributed around progenitor with a density related to the mass-loss rate and the wind velocity at the time it was lost and to the time itself.
Mass loss rates for RSG are extremely difficult to characterize with observations due to both the short period of this phase as well as the rarity of high mass stars and they are not well understood theoretically.
Thus the mass loss rates for RSG are uncertain, with typical density estimates between $10^{-6}-10^{-4}$ \msun/yr and velocities between $10-100$ km/s \citep{2011mauron}.
Although typically assumed to be negligible, it is possible that the signatures of interaction with circumstellar material (CSM; with stellar wind origins) are visible in the light curves and spectroscopy of Type IIP/IIL SNe, especially outside of the optical where there are fewer observations.
...
Recent, unprecedented early spectroscopy of some IIP/IIL SNe show narrow emission lines that disappear within the first hours to days post explosion (e.g. \citealt{2014gal-yam}, \citealt{ 2017yaron}), indicating a thin dense CSM shell around the progenitor. 
Corroborating this picture (although for different objects), dense CSM is also required to match the early optical light curves of IIP/IIL SNe with hydrodynamic models with RSG progenitors \citep{2018morozova,2018paxton}.
...
While signs of interaction in IIP/IIL SNe exist, a coherent picture of mass-loss is exceedingly rare and has never been attempted for IIL-like SN, the subtype most likely to show signs of interaction.
In this paper, for the first time, we address this issue with the study of ASASSN-15oz, a IIL-like SN, for which we were able to collect an extensive set of data ranging from the X-ray to the radio to search for signs of interaction with a CSM.

The outline of the paper is as follows.
In Section \ref{15ozIntro} we present the supernova parameters of ASASSN-15oz.
...
Section \ref{sec:Interaction} describes our search for interaction, including extensive hydrodynamic light curve modeling and radio.
...
Supernova ASASSN-15oz was discovered by the ASAS-SN team on 2015-08-31 (JD 2457265) and announced on 2015-09-03 (JD 2457268) \citep{2016brown}. 
...
Imaging of HIPASS J1919-33 from 2015-08-23 (JD 2457257.5) does not show any evidence of ASASSN-15oz (V $>$ 17.8). 
...
ASASSN-15oz is a IIL-like SN and our first spectrum is from around maximum. 
SNID has very few templates for IIL-like SNe even after adding the new templates provided by \citet{2017gutierrez}. 
Therefore, we add templates for two well observed supernovae with well constrained explosion epochs: 2012A and 2013ej.
We confirm our explosion epoch by fitting the first spectrum (2015-09-04; JD 2457269.5) using SNID v. 5.0, augmenting the templates with those of \citet{2017gutierrez}, SN2012A \citep{2013tomasella}, and SN2013ej \citep{2016childress,2016dhungana,2014valenti,2015smartt}.
...
We find no evidence of Na I absorption at the host redshift and therefore assume no host absorption (see Figure \ref{fig:extinction}). 
...
\caption{The Na I D1 and D2 lines in high resolution X-shooter spectrum from 2015-09-21 (JD 2457286.5) for galactic and host absorption.
...
\Stefano{is this too strong a statement?}}
...
Following the method described in \citet{2014spiro} we find the nickel mass synthesized in a supernova explosion by scaling the bolometric luminosity of ASASSN-15oz when it is powered by ${}^{56}Co$ to that of supernova 1987A using the following relation:
...
We supplemented these observations with dedicated projects in the X-ray and UV with \textit{Swift} (1114241, PI: Valenti). 
...
UV and X-Ray imaging observations were obtained concurrently with \textit{Swift} programs 1114241 and XXXXXXX from 2015-09-05 (JD 2457270.5) through 2015-11-18 (JD 2457344.5).
...
ASASSN-15oz was observed in the near infra-red (NIR) on 2015-09-05 (JD 2457270.5) and 2015-10-05 (JD 2457300.5) with the SOFI instrument and on 2015-10-10 (JD 2457305.5) with the SpeX instrument  \citep{2003rayner}.
...
The light curve of all IIP/IIL SNe show an initial rise, followed by a period of 100 days during which the SN stays the same brightness or declines linearly. 
During this time the light curve is mainly powered by energy produced during the recombination of the hydrogen envelope. 
The expansion of the ejecta approximately balances the receding hydrogen recombination front, leading to a close to constant photospheric radius. 
...
After the fall from plateau, the main contribution to the light curve is the energy produced by the radioactive decay of ${}^{56}$Co to ${}^{56}$Fe.
...
Following \citet{2014anderson} we fit a slope to the first steep initial decline after maximum ($s_1$) and to the second shallower slope prior to the fall from plateau ($s_2$). 
...
This is because [OI] is more isolated and less sensitive to the explosive nucleosynthesis of the supernova than the other lines and thus reflects the oxygen abundance of the progenitor which has been shown to correlate well with progenitor mass \citep{1995woosley}.
...
\caption{A nebular spectrum of ASASSN-15oz from 2016-04-11 (JD 2457489.5; day 228; top) and 2016-08-03 (JD 2457603.5; day 340; bottom) plotted with the scaled models of \citet{2014jerkstrand} for MZAMS = 12, 15, 19, and 25 M$_{\odot}$. 
...
The mass loss of stars with dense CSM (e.g. IIn SNe) that show strong evidence of interaction such as narrow emission lines in photospheric spectra or irregular photometric brightening is often studied,, the mass-loss of SNe with lower density CSM is often ignored.
...
The linear shape of the light curve of IIL SNe is best explained by a thin hydrogen envelope on the progenitor, implying that IIL-like SNe should undergo more mass-loss than IIP-like SNe.
ASASSN-15oz, a IIL-like SN with photometric and spectroscopic observations from the X-ray through the radio is the ideal SN on which to study the importance of mass-loss for IIP-like and IIL-like SNe and if different observational signatures of interaction are consistent with each other. \Stefano{is there a better way to say this?}
...
The \textit{Swift} grism observations show no sign of the narrow emission lines typically associated with strong interaction (CSM densities $> 10^{-4}$ g/cm; \citet{2012kiewe})
%=======================
\begin{figure*}
\begin{center}
...
Building on a similar analysis of single object (e.g. 1999em: \citealt{2001leonard}, 2013ej: \citealt{2014valenti}), \citet{2017gutierrez} searched for this feature in 122 IIP/IIL SNe. 
...
\caption{A comparison of the velocity of the Cachito feature if it is Si II ($\lambda=6355$) (blue triangles) and the velocity of the metals in the ejecta as characterized by the Fe II $\lambda=5169$ lines (orange circles).
...
Recently, Paxton et al. 2018 demonstrated that IIP/IIL SNe are well characterized by the radiation diffusion approximation from shock breakout through the fall from plateau.
...
This behavior was previously noted by \citet{2018paxton} who find that the Fe II $\lambda$5169 line is originating above the photosphere where the Sobolov optical depth ($\tau_{sob}$)is a specific value (they find $\tau_{sob} \sim1$ fits the observations well). 
...
We note that although the Fe II $\lambda$5169 line is most often used to measure photospheric velocity, it is unclear how well it traces the photosphere. 
\citet{2001hamuy}, in comparing the velocity derived from the Fe II $\lambda$5169 line to the photospheric velocity in the Type II SN atmospheric models of \citet{1996eastman}, find a systematic offset for individual objects. 
However, this offset is in different directions for different objects, leading to no average offset. 
%=======================
\begin{figure}
\begin{center}
\includegraphics[width=\columnwidth]{snec_velocity_comp} %WHERE DID THIS COME FROM?
...
Although they are part of a continuous class, IIL-like SNe typically have higher velocity ejecta, are brighter, and have a steeper light curve slope than the average IIP-like SN.
...
Population studies of IIP/IIL SNe have found that SNe with steeper light curves are brighter \citep{2011li,2014anderson,2015sanders,2016valenti}, either due to a larger explosion energy, a larger progenitor, or both. \Stefano{Is this true, does it need a citation?}
Using our database of publicly available light curves, SNDAVIS \footnote{http://dark.physics.ucdavis.edu/sndavis/transient}, we plot the photospheric slope ($s_{50V}$) and the absolute V-band magnitude for XX SNe (see Figure \ref{fig:SlopeMag}). 
...
\caption{The absolute V-band magnitude of a sample of public SNe from the SNDAVIS database compared to their photospheric slope ($s_{50V}$) (blue circles). 
The trend seen by \citet{2014anderson} and \citet{2016valenti} of brighter SNe to have steeper slopes is apparent. 
ASASSN-15oz follows this relationship and is plotted over the sample as an orange star.
}
\label{fig:SlopeMag}
\end{center}
\end{figure}
...
We derived mass loss parameters from both the light curve modeling with SNEC  and the radio observation modeling.
...
This is significantly higher than radio mass-loss rate which is consistent with the typical RSG mass-loss rate of $10^{-4} $- $10^{-6}$ \msun/yr, although not inconsistent with late stage mass-loss scenarios (e.g. \citealt{2012quatert,2014shiode,2017fuller, 2017yaron}).
...
We explore this by plotting UV color {\it Swift} UVW2 - V over the first 30 days of evolution for eight SNe in our database with both {\it Swift} photometry and $s_{50V}$ measurements (Figure \ref{fig:UVColor}). 
The symbols for each SNe are colored by the V-band slope at 50 days. 
Although a wide range of slopes are represented, no correlation between UV excess and slope is observed.
...
We find our upper limit is above all other detection and upper limits of IIP/IIL SNe in the database.
...
All detections from IIP/IIL SNe are below the upper limit derived in this paper, implying that deeper observations would be required to detect the X-ray flux.}
\label{fig:xray}
\end{center}
\end{figure}
%-----------------------------------------
