...
def make_fits_bintable(input_filename, output_filename='multi', clobber=False):
    ...
    columns = fits.ColDefs([fits.Column(array=wl, name='WAVELENGTH', format='E'), 
                            fits.Column(array=array_table[0,0,:], name='OPTIMAL_FLUX', format='E'),
                            fits.Column(array=array_table[1,0,:] , name='FLUX', format='E'),
                            fits.Column(array=array_table[2,0,:], name='SKY', format='E'),
                            fits.Column(array=array_table[3,0,:], name='ERROR', format='E')])
